...
use App\Models\{Vehicle, Driver, Student, TimetableSlot, ClassRoom, TransportRoute, VehicleTelemetry, TransportGeofence, GeofenceEvent};
...
class TransportController extends Controller
{
    ...
    public function drivers(): JsonResponse
    {
        $drivers = Driver::where('status', 'active')
            ->whereHas('transportRoutes', fn($query) => $query->where('school_id', currentSchoolId()))
            ->get();
    ...
    public function reportPickupStatus(Request $request, $routeId): JsonResponse
    {
        ...
        $assignment = DB::table('transport_assignments')
        ...
        $this->dispatchTransportSmsNotifications(
            $route->school_id,
